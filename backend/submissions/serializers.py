...
class SubmissionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ('user', 'status', 'rating', 'feedback', 'reviewed_at', 'reviewed_by')
...
class SkillScoreSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        model = SkillScore
        fields = (
            'overall_score', 'quality_score', 'consistency_score',
            'problem_solving_score', 'improvement_score', 'last_calculated',
        )
